...
namespace Senai.Chamados.Data.Repositorios
{
    ...
    {   
        ...
        {
            var chamado = _contexto.Usuarios.Single(o => o.Id == domain.Id);
            _contexto.Usuarios.Remove(chamado);
        ...
        public List<ChamadoDomain> Listar(Guid idUsuario, string[] includes = null)
        {
            ...
            /*comparação de usuario que esta logado voltando os seus chamados*/
